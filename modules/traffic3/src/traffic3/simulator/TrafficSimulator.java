...
import rione.AgentExporter;
import rione.TrafficExporter;
...
public class TrafficSimulator extends StandardSimulator implements GUIComponent {
    ...
    private TrafficExporter trafficExporter = new TrafficExporter();
    private AgentExporter agentExporter = new AgentExporter();
    ...
    protected void processCommands (KSCommands c, ChangeSet changes) {
        ...
        timestep();
        trafficExporter.exportTrafficLog(manager, c.getTime());
        agentExporter.exportAgentLog(manager, c.getTime());
        for (TrafficAgent agent : manager.getAgents()) {
