...
import rione.viewer.TacticsExporter;
...
public class SampleTacticsAmbulanceTeam extends TacticsAmbulanceTeam {
    ...
    // Exporter 追加記述
    private TacticsExporter exporter;
    ...
    public void initialize (AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, MessageManager messageManager, DevelopData developData) {
        ...
        // Exporter 追加記述
        this.exporter = new TacticsExporter(agentInfo);
    }
    ...
    public Action think (AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, MessageManager messageManager, DevelopData developData) {
        ...
        if ( this.recentCommand != null ) {
            ...
            if ( action != null ) {
                ...
                // Exporter 追加記述
                exporter.export(agentInfo, messageManager, action, null);
                return action;
            }
        }
        // autonomous
        ...
        if ( action != null ) {
            this.sendActionMessage(messageManager, agent, action);
            // Exporter 追加記述
            exporter.export(agentInfo, messageManager, action, target);
            return action;
        }
